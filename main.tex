...
\begin{frame}
	...
	\begin{columns}[c]
		\begin{column}{0.35\textwidth}
			...
			\begin{description}
				\item<1>[\javainline{flowsTo(b)}]\hfill\\ Traverse all paths that lead to b.
				\item<1->[\javainline{flowsFrom(}\alt<1>{\javainline{a)}}{\javainline{param_n)}}]\hfill\\ Traverse all paths start start at a.
